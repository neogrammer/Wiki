...
1. Download the [Texconv.exe](https://github.com/Microsoft/DirectXTex/releases/download/sept2016/texconv.exe) from the _DirectXTex_ site save the EXE into your project's folder.
