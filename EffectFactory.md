...
* **EnableNormalMapEffect** is used to determine of [[NormalMapEffect]] is used for models containing normal-map textures. This defaults to true. If set to false, it will use [[BasicEffect]] instead for these materials. _This option is not supported by DGSLEffectFactory_.
