...
> For UWP applications on Xbox One, the game controller can be made to emulate a mouse but the input paradigm is more natural if you use the [[GamePad]] class directly.
