...
**SimpleMath** is included in the *DirectX Tool Kit* for DX11 / DX12, but the implementation is fully standalone. You could use these source files directly in a project if you do not want to use the rest of the toolkit: [SimpleMath.h](https://github.com/microsoft/DirectXTK/blob/main/Inc/SimpleMath.h), [SimpleMath.inl](https://github.com/microsoft/DirectXTK/blob/main/Inc/SimpleMath.inl), and [SimpleMath.cpp](https://github.com/microsoft/DirectXTK/blob/main/Src/SimpleMath.cpp).
