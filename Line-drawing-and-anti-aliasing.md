...
* This tutorial uses the standard 3D graphics "world -> view -> projection" transformation pipeline. If you are unfamiliar with this pipeline and/or matrix transformations, see the [[math tutorial|Using the SimpleMath library]] for additional learning resources.
