After creating a new project in the [[The basic game loop]] (or using the [[DeviceResources]] variant), the next step is to add the _DirectX Tool Kit_ to the project so we can make use of it in our code.
