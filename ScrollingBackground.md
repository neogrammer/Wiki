This is an example of a C++ port of the C# [XNA Game Studio sample](https://msdn.microsoft.com/en-us/library/bb203868.aspx) class for drawing a scrolling background using [[SpriteBatch]].
