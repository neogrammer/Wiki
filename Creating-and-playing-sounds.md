...
1. Download the [XWBTool.exe](https://github.com/Microsoft/DirectXTK/releases/download/jun2016/XWBTool.exe) from the _DirectX Tool Kit_ site and extract the EXE into your project's folder. 
