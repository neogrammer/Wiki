...
1. Download the [XWBTool.exe](https://github.com/Microsoft/DirectXTK/releases/download/aug2016c/XWBTool.exe) from the _DirectX Tool Kit_ site and extract the EXE into your project's folder. 
