...
1. Download the [Meshconvert.exe](https://github.com/Microsoft/DirectXMesh/releases/download/aug2016/meshconvert.exe) from the _DirectXMesh_ site save the EXE into your project's folder.
