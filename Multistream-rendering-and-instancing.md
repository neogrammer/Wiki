...
* To render **Model** with instancing, you must use custom drawing to create the proper input layout object, as well as call ``DrawInstanced`` for each **ModelMeshPart**.
