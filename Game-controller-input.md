...
> If using DirectX 12, you will also need a BasicEffect, CommonStates, and DescriptorHeap to render this scene. See the [3D Shapes](https://github.com/microsoft/DirectXTK12/wiki/3D-shapes) tutorial for more details.
