...
> If you are more comfortable with C#, then you should consider [SharpDX](http://sharpdx.org/) and [this blog post](https://devblogs.microsoft.com/dotnet/choose-a-net-game-engine/).
